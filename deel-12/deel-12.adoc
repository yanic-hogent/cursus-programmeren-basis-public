...
In deel 0 zagen we dat waarden in een computer voorgesteld worden door combinaties van *bits*. In onze programma's legt het *datatype* van een variabele vast welk soort waarde we in de opslagplaats kunnen bijhouden.
...
Er wordt in dit voorbeeld gebruik gemaakt van de __format strings__ '0:f20').
****
