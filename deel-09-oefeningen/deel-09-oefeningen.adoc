...
Elke letter van het alfabet heeft een score die op de overeenkomstige blokjes staat, je kunt deze opzoeken op link:https://nl.wikipedia.org/wiki/Scrabble[de Wikipedia pagina voor Scrabble, window=_blank]. De __IJ__ en blanco blokjes zijn voor ons niet relevant.
...
Schrijf een programma dat de som van het aantal karaketers van een reeks woorden kan bepalen.
...
Indien het `woorden` array de __andere woorderen__ bevat.
