...
getal1 = double.Parse(deler_als_tekst);

Console.Write("Deler?: ");
delerAlsTekst = Console.ReadLine();
Getal2 = double.Parse(delerAlsTekst);
...
- we laten oninteressante regels weg die aan geen enkele variabele een waarde toekennen (bv. regels 3, 7 ,8 en 9)
